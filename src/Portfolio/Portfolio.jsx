      ...
      <div className="d-flex flex-wrap">
          ...
          <div className="portfolio-item right-margin border border-dark bg-white d-flex align-items-center">
            ...
            <div className="item-inner col-12 col-md-6 col-lg-6 px-4">
              <div className="technology d-flex flex-wrap">
                <p className="bg-mongo rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  MongoDB
                </p>
                <p className="bg-express rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  Express.js
                </p>
                <p className="bg-react rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  React.js
                </p>
                <p className="bg-node rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  Node.js
                </p>
                <p className="bg-js rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  JavaScript
                </p>
              </div>
        ...
        <div className="col-12 col-lg-6">
          <div className="portfolio-item right-margin border border-dark bg-white mt-3 d-flex align-items-center">
            ...
            <div className="item-inner col-12 col-md-6 col-lg-6 px-4">
              <div className="technology d-flex flex-wrap">
                <p className="bg-django rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  Django
                </p>
                <p className="bg-python rounded-pill text-center py-1 px-2 pb-2 me-2 mb-2">
                  Python
                </p>
              </div>
